...
var Scroller = (_temp = _class = function(_Component) {
    ...
    (0, _createClass3.default)(Scroller, [{
        ...
        value: function touchEnd(e) {
            ...
            if (this.props.momentum && duration < 300) {
                momentumX = this.hasHorizontalScroll ? _utils2.default.momentum(this.x, this.startX, duration, this.maxScrollX, this.props.bounce ? this.wrapperWidth : 0, this.props.deceleration) : {
                    destination: newX,
                    duration: 0
                };
                momentumY = this.hasVerticalScroll ? _utils2.default.momentum(this.y, this.startY, duration, this.maxScrollY, this.props.bounce ? this.wrapperHeight : 0, this.props.deceleration) : {
                    destination: newY,
                    duration: 0
                };
                    ...
                    usePullRefresh ? _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('i', {
                                className: 'silk-listcontrol-icon'
                            }),
                            _react2.default.createElement('div', {
                                className: 'silk-listcontrol-text'
                            })
                        )
                    ) : null,
                    this.props.children,
     ...
     * */
    eventPassthrough: PropTypes.oneOfType([PropTypes.bool, PropTypes.string]),
    /**
     * 方向锁定阈值
     * */
